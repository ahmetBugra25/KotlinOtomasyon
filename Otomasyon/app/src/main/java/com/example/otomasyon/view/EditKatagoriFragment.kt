...
class EditKatagoriFragment : Fragment() {
    private  var _binding: FragmentEditKatagoriBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentEditKatagoriBinding.inflate(inflater, container, false)
    ...
    private fun handleResponse(katagoriler : List<Katagori>){
        val adapter = KatagoriAdapter("EditKatagori",katagoriler)
